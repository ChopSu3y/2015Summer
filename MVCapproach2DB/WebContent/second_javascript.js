...
function update_month(month_element, year_element, loading_pic) {
	...
	$.ajax({
		...
		success: function(order) {
			month_element.append($('<option>', {value:""}).text("Please select an option"));//Add this option to the beginning month list
...
function update_year_and_clear_month(year, month, loading) { //this is helper function for when component param changes, update months and year
	...
	$.ajax({
		...
		error: function() {
			console.log("There is an error in update_year_and_month");
		},
		complete: function() {

...
<html>
	<head>
		...
		<script src="third_javascript.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
		...
		<title>Report 3s</title>
	</head>
	
	<body>
		<!-- 
		<input type="submit" name="Line" value="Line" id="Submit7"/>
		
		<input type="submit" name="Column" value="Column" id="column"/>
		
		<div id="chartdiv" style="width: 1400px; height: 600px;"></div>
		!-->
  	...
  	<div class="container">
		...
		<p></p>
		Start Day<span><strong>:</strong></span>
		<select name="dayparam_start" id="dayparam_start" style="max-width: 90%">
		
		</select>
		<div id="loading-start_day-click">
			<img src="loading.gif" />
		</div>	
		...
		<p></p>
		End Day<span><strong>:</strong></span>

		<select name="dayparam_end" id="dayparam_end" style="max-width: 90%">

		</select>
		
		<div id="loading-end_day-click">
			<img src="loading.gif" />
		</div>
